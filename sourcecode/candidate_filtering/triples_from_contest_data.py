from evaluate import TrainedFilteringModel

from config import Config
import csv
contest_data_filename = '../../datasets/icdm_contest_data.csv'

industries = ['automotiveEngineering']#, 'cateringServices']
...
def main():
	...
	with open('output/submission.csv', 'w') as f:
		...
		for industry in industries:		
			...
			FilteringModel = TrainedFilteringModel(industry, cf)
			triples = FilteringModel.triples_from_docs(data[industry])
